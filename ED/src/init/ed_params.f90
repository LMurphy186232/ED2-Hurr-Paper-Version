...
subroutine init_pft_alloc_params()
   ...
   ! LEM hardcoding
   !---------------------------------------------------------------------------------------!
   b1Bs_small(3) = 0.08373428
   b1Bs_large(3) = 0.08373428
   b2Bs_small(3) = 2.412549
   b2Bs_large(3) = 2.412549

   b1Bs_small(4) = 0.1078351
   b1Bs_large(4) = 0.1078351
   b2Bs_small(4) = 2.520187
   b2Bs_large(4) = 2.520187
